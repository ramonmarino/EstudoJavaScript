DESCRIÇÃO: Este repositório contém linguagem JavaScript com o propósito de revisão e treino de vários conceitos importantes dentro da linguagem e lógica da Programação.
